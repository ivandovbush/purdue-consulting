      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="font-space-grotesk font-bold text-4xl md:text-5xl mb-4 text-yellow-500">
            Our <span className="text-mocha-brown">Partners</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {partners.map((partner, index) => (
            <div
              key={index}
              className="group bg-dark-cream border border-warm-brown/20 rounded-lg p-6 hover:border-yellow-500/50 transition-all duration-300 hover:transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              <div className="text-center">
                <div className="w-16 h-16 bg-light-cream rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:bg-yellow-500/30 transition-all duration-300 overflow-hidden">
                  <img 
                    src={partner.logo} 
                    alt={partner.name}
                ...
                <h3 className="font-inter font-medium text-mocha-brown text-sm group-hover:text-yellow-500 transition-colors duration-300">
                  {partner.name}
                </h3>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            <div className="w-12 h-12 bg-dark-cream rounded-lg flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-mocha-brown text-sm font-inter">Fast-track interviews and exclusive recruiting events with partner firms.</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-mocha-brown text-sm font-inter">Work on actual business challenges and strategic initiatives.</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-mocha-brown text-sm font-inter">Personal guidance from senior partners and experienced consultants.</p>
          </div>
        </div>
      </div>
    </section>
