      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="font-space-grotesk font-bold text-4xl md:text-5xl mb-4 text-yellow-500">
            Purdue Alumni <span className="text-mocha-brown">Network</span>
          </h2>
          <p className="text-mocha-brown text-lg max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {alumni.map((person, index) => (
            <Card key={index} className="bg-dark-cream border-warm-brown/20 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-mocha-brown font-semibold mb-1">
                  {person.title}
                </p>
                
                <p className="text-mocha-brown text-sm mb-2">
                  {person.company}
                </p>
                
                <div className="flex items-center justify-center gap-1 text-mocha-brown text-sm mb-2">
                  <MapPin className="w-3 h-3" />
                  <span>{person.location}</span>
                </div>
                
                <div className="text-xs text-yellow-500 bg-light-cream px-2 py-1 rounded-full inline-block">
        ...
        <div className="text-center mt-12">
          <div className="bg-dark-cream rounded-lg p-8 max-w-2xl mx-auto border border-warm-brown/20">
            <h3 className="font-space-grotesk font-bold text-2xl mb-4 text-yellow-500">
              Join Our Growing Network
            </h3>
            <p className="text-mocha-brown mb-6">
            ...
            <div className="text-sm text-mocha-brown">
