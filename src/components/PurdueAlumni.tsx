...
const PurdueAlumni = () => {
  ...
  return (
    <section id="alumni" className="py-16 bg-warm-dark">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="font-space-grotesk font-bold text-4xl md:text-5xl mb-4 text-yellow-500">
            Purdue Alumni <span className="text-[#FEF7E5]">Network</span>
          </h2>
          <p className="text-[#FEF7E5] text-lg max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
          <div className="text-center p-6 bg-gradient-to-br from-warm-brown/20 to-transparent rounded-lg border border-light-tan">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {alumni.map((person, index) => (
            <Card key={index} className="bg-gradient-to-br from-warm-brown/20 to-transparent border-light-tan hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-6 text-center">
                <Avatar className="w-20 h-20 mx-auto mb-4 border-2 border-yellow-500">
                  ...
                  />
                  <AvatarFallback className="bg-warm-brown text-[#FEF7E5] text-lg font-bold">
                    {person.initials}
                  </AvatarFallback>
                </Avatar>
                ...
                <div className="text-xs text-yellow-500 bg-warm-brown/30 px-2 py-1 rounded-full inline-block">
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-warm-brown/20 to-transparent rounded-lg p-8 max-w-2xl mx-auto border border-light-tan">
