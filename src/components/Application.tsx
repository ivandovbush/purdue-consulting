...
const Application = () => {
  ...
  return (
    <section id="application" className="py-20 bg-warm-dark/50">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Application Form */}
            <div className="bg-warm-dark/80 backdrop-blur-sm border border-light-tan rounded-lg p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="firstName" className="text-gold-hint font-inter">First Name *</Label>
                    <Input
                      id="firstName"
                      name="firstName"
                      value={formData.firstName}
                      onChange={handleInputChange}
                      className="bg-light-cream/50 border-light-tan text-warm-dark focus:border-gold-hint"
                      required
                    />
                  </div>
                  <div>
                    <Label htmlFor="lastName" className="text-gold-hint font-inter">Last Name *</Label>
                    <Input
                      id="lastName"
                      name="lastName"
                ...
                <div>
                  <Label htmlFor="email" className="text-gold-hint font-inter">Purdue Email *</Label>
                  <Input
                    id="email"
                    name="email"
                    type="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="major" className="text-gold-hint font-inter">Major *</Label>
                    <Input
                      id="major"
                      name="major"
                  ...
                  <div>
                    <Label htmlFor="year" className="text-gold-hint font-inter">Year *</Label>
                    <Input
                      id="year"
                      name="year"
                      value={formData.year}
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className="bg-light-cream/50 border-light-tan text-warm-dark focus:border-gold-hint resize-none"
                    required
                  />
                </div>
                ...
                <Button 
                  ...
                  className="w-full bg-gold-hint hover:bg-gold-hint/80 text-warm-dark font-semibold py-3 transition-all duration-300 disabled:opacity-50"
                >
