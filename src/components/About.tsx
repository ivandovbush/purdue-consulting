...
const About = () => {
  return (
    <section id="about" className="py-20 bg-warm-dark">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[#FEF7E5] text-lg leading-relaxed font-inter">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-warm-brown/20 to-transparent p-8 rounded-lg backdrop-blur-sm border border-light-tan">
              <div className="space-y-4">
                <h3 className="font-space-grotesk font-semibold text-xl text-[#FEF7E5]">Our Values</h3>
