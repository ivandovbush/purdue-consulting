      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="font-space-grotesk font-bold text-4xl md:text-5xl mb-4 text-yellow-500">
            Faculty <span className="text-warm-dark">Advisor</span>
          </h2>
          <p className="text-warm-dark text-lg max-w-2xl mx-auto">
            Meet our dedicated faculty advisor who guides and supports our consulting endeavors
          </p>
        </div>

        <div className="max-w-4xl mx-auto">
          <Card className="bg-light-cream border-warm-brown/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-warm-dark font-semibold text-lg mb-4">
                    Edwardson School of Industrial Engineering
                  </p>
                  
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center justify-center md:justify-start gap-3 text-warm-dark">
