...
const Admissions = () => {
  ...
  return (
    <section id="admissions" className="py-20 bg-light-cream">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="font-space-grotesk font-bold text-4xl md:text-5xl mb-4 text-warm-dark">
            Admissions <span className="text-warm-brown">Process</span>
          </h2>
              ...
              <div key={index} className="relative">
                ...
                <div className="flex items-start space-x-8">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 bg-warm-brown text-cream rounded-full flex items-center justify-center font-space-grotesk font-bold text-lg shadow-lg">
                      {step.step}
                    </div>
                  </div>
                  ...
                  <div className="flex-1 pt-2">
                    <div className="bg-cream backdrop-blur-sm border border-light-tan rounded-lg p-6 hover:border-warm-brown/50 transition-all duration-300 shadow-lg">
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-warm-brown/10 to-transparent p-8 rounded-lg border border-light-tan shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                  <div className="text-3xl font-space-grotesk font-bold text-warm-brown mb-2">82%</div>
                  <div className="text-mid-brown text-sm font-inter">Job Placement Rate</div>
                </div>
                <div>
                  <div className="text-3xl font-space-grotesk font-bold text-warm-brown mb-2">3.7+</div>
                  <div className="text-mid-brown text-sm font-inter">Average GPA</div>
                </div>
                <div>
                  <div className="text-3xl font-space-grotesk font-bold text-warm-brown mb-2">1 week</div>
                  <div className="text-mid-brown text-sm font-inter">Application Review Time</div>
                </div>
              </div>
            </div>
          </div>
